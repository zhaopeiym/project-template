...
namespace ProjectNameTemplate.Common.Helper
{
    ...
    public class EnumHelper<TEnum, TRaw>
    {
        public EnumHelper()
        {

        }
        public EnumHelper(TEnum value, TRaw raw, string strEnum)
        {
            EnumValue = value;
            RawValue = raw;
            EnumString = strEnum;
    ...
    public static class EnumHelper
    {
        ...
        /// <returns></returns>
        public static Dictionary<string, string> ConvertEnumToList<T>(IEnumerable<T> excludes = null, Func<T, string, string> func = null)
        {
        ...
        public static List<EnumHelper<TEnum, TRaw>> ConvertEnumToEntryList<TEnum, TRaw>(IEnumerable<TEnum> excludes = null, Func<TRaw, string, string> func = null)
        {
            var enumType = typeof(TEnum);
            var list = new List<EnumHelper<TEnum, TRaw>>();
            ...
            foreach (var item in lstEnums)
            {
                ...
                var entry = new EnumHelper<TEnum, TRaw>(item, rawVal, strEnum)
                {
        ...
        /// <returns></returns>
        public static string GetEnumShortNameByCode<T, T1>(List<EnumHelper<T, T1>> enums, string code, string spliteSChar = "[", string spliteEChar = "]")
        {
